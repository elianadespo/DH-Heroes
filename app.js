...
app.get('/clarke', (req, res)=> res.sendFile(path.join(__dirname, 'views', 'arthur-clarke.html')));
app.get('/hamilton', (req, res)=> res.sendFile(path.join(__dirname, 'views', 'hamilton.html')));
app.get('/hopper', (req, res)=> res.sendFile(path.join(__dirname, 'views', 'grace-hopper.html')));
